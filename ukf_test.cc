...
TEST_CASE("UKF Predict and Estimate Funtions Test", "[ukf]") {
  Ukf ukf;
  //set state dimension
  ukf.n_x_ = 5;
  ...
  /*
   * The matrices below will be need for the different sections and the tests
   * go down in order.
   * PREDICT STEP
  ...
  SECTION("GenerateSigmaPoints() Test", "[sigmapoints]") {
